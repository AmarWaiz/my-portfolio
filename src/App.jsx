...
export default function App() {
  ...
  useEffect(() => {
    ...
    favicon.rel = 'icon';
    favicon.href = 'data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><defs><linearGradient id="grad" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:%238b5cf6;stop-opacity:1" /><stop offset="50%" style="stop-color:%2306b6d4;stop-opacity:1" /><stop offset="100%" style="stop-color:%23f59e0b;stop-opacity:1" /></linearGradient></defs><rect x="15" y="30" width="8" height="25" rx="4" fill="url(%23grad)" transform="rotate(-30 15 30)"/><rect x="42" y="15" width="8" height="60" rx="4" fill="url(%23grad)" transform="rotate(15 42 15)"/><rect x="70" y="30" width="8" height="25" rx="4" fill="url(%23grad)" transform="rotate(30 70 30)"/></svg>';
    ...
    <>
      ...
      <header className="site-nav">
        ...
        <div className="container nav-inner">
          ...
          <a className={`btn primary desktop-resume ${!isMobile ? 'magnetic' : ''}`} href="/resume.pdf">
            <span>Resume</span>
